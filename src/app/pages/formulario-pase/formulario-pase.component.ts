...
@Component({
  selector: 'app-formulario-pase',
  templateUrl: './formulario-pase.component.html',
  styleUrls: ['./formulario-pase.component.scss']
})
export class FormularioPaseComponent implements OnInit, OnDestroy {
